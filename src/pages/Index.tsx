      ...
      <div className="flex-1 px-4">
        ...
        <div className="mb-8 px-2">
          <p className="text-cream/90 text-center leading-relaxed font-serif italic text-lg tracking-wide">
            <span className="block text-lg font-light mb-1 bg-gradient-to-r from-yellow-200 via-cream to-yellow-100 bg-clip-text text-transparent drop-shadow-sm">
              "Bassline is a music-powered platform,
            </span>
            <span className="block text-lg font-light mb-1 text-cream/80">
              aiming to engage you with exercise
            </span>
            <span className="block text-lg font-light mb-1 text-cream/80">
              in whatever format you want,
            </span>
            <span className="block text-lg font-light bg-gradient-to-r from-yellow-200 via-cream to-yellow-100 bg-clip-text text-transparent drop-shadow-sm">
